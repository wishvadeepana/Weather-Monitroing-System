boolean connect_ESP(){//returns 1 if successful or 0 if not
  ...
  //TFTscreen.text("Connecting Wifi....",0,0);
  ESP8266.print("AT+CIPSTART=0,\"TCP\",\"www.weatherstation.dx.am\",80\r\n");//connect to your web server
  //ESP8266.print("AT+CIPSTART=0,\"TCP\",\"192.168.8.102\",80\r\n");
